                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2 col-xs-12">
                        <div class="mainheading">
                            ...
                            <h1 class="posttitle">
                                <asp:Label ID="Label2" runat="server" Text='<%# Eval("blogTitle") %>'></asp:Label></h1>

                        </div>

                        <!-- Begin Featured Image -->
                        <asp:Image ID="Image1" CssClass="featured-image img-fluid" ImageUrl='<%# Eval("blogImg") %>' runat="server" />
                        <!-- End Featured Image -->
                        <!-- Begin Post Content -->
