<%@ Page Title="" Language="C#" MasterPageFile="~/mediumish-html/DefaultLayout.Master" AutoEventWireup="true" CodeBehind="editprofile.aspx.cs" Inherits="BlogWeb.mediumish_html.editprofile" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src='https://media.istockphoto.com/id/846418502/vector/feather-icon.jpg?s=612x612&w=0&k=20&c=kt_rKYHJZr7zqBAUhtXqB8naMxRhApbusXCUTgfDWNM=' alt="Admin" class="rounded-circle" width="150">
                                <div class="mt-3">
                                    <h4>Yazar İsmi</h4>
                                    <p class="text-secondary mb-1">Unvan</p>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary tbm">
                                    <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" Text='Link Github'></asp:TextBox>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary tbm">
                                    <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" Text="boodeyyy"></asp:TextBox>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary tbm">
                                    <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" Text="boodeyyy"></asp:TextBox>
                                    <!-- ***** -->
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary tbm">
                                    <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" Text="boodeyyy"></asp:TextBox>
                                    <!-- ***** -->
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary tbm">
                                    <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" Text="boo"></asp:TextBox>
                                    <!-- ***** -->
                                </span>
                            </li>
                        </ul>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <asp:TextBox CssClass="col-sm-9 text-secondary form-control tbmm" ID="TextBox1" runat="server" Text=""></asp:TextBox>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <asp:TextBox CssClass="col-sm-9 text-secondary form-control tbmm" ID="TextBox2" runat="server" Text=""></asp:TextBox>
                                <!-- ***** -->
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <asp:TextBox CssClass="col-sm-9 text-secondary form-control tbmm" ID="TextBox3" runat="server" Text=""></asp:TextBox>
                                <!-- ***** -->
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <asp:TextBox CssClass="col-sm-9 text-secondary form-control tbmm" ID="TextBox4" runat="server" Text=""></asp:TextBox>
                                <!-- ***** -->
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <asp:TextBox CssClass="col-sm-9 text-secondary form-control tbmm" ID="TextBox5" runat="server" Text=""></asp:TextBox>
                                <!-- ***** -->
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <asp:TextBox CssClass="col-sm-9 text-secondary form-control tbmm" ID="TextBox11" runat="server" Text=""></asp:TextBox>
                                <!-- ***** -->
                            </div>
                            <hr>
                            <div class="row">
