<%@ Page Title="" Language="C#" MasterPageFile="DefaultLayout.Master" AutoEventWireup="true" CodeBehind="profil.aspx.cs" Inherits="BlogWeb.mediumish_html.profil" %>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary tbm">
                                            <asp:TextBox CssClass="form-control-static" ID="TextBox10" runat="server" Text='<%#Eval("github") %>' Enabled="false"></asp:TextBox>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary tbm">
                                            <asp:TextBox CssClass="form-control-static" ID="TextBox6" runat="server" Text='<%#Eval("github") %>' Enabled="false"></asp:TextBox>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary tnm">
                                            <asp:TextBox CssClass="form-control-static" ID="TextBox7" runat="server" Text='<%#Eval("github") %>' Enabled="false"></asp:TextBox>
                                            <!-- ***** -->
                                        </span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary tbm">
                                            <asp:TextBox CssClass="form-control-static" ID="TextBox8" runat="server" Text='<%#Eval("github") %>' Enabled="false"></asp:TextBox>
                                            <!-- ***** -->
                                        </span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary tbm">
                                            <asp:TextBox CssClass="form-control-static" ID="TextBox9" runat="server" Text='<%#Eval("github") %>' Enabled="false"></asp:TextBox>
                                            <!-- ***** -->
                                        </span>
                                    </li>
                                </ul>
